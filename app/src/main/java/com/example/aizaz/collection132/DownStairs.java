 ...
 */
public class DownStairs extends AppCompatActivity implements SensorEventListener {
    ...
    @SuppressLint("SdCardPath")protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.downstairs);
       ...
       // filename= FileName.toString();
        ...
        String nameStr = new String("/storage/sdcard0/" + "Downstairs" + ".csv");
        ...
        String toSpeak = "Downstairs Dataset";
        ...
        btnStartTemplate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(v.getId() == R.id.btnStartTemplate){
                    ...
                    list.clear();
                    String ToSpeak = "Downstairs Dataset Starting in 5 seconds";
                            ...
                            new java.util.TimerTask() {
                                ...
                                public void run() {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            //your code
                                            String toSpeak = "Downstairs Recording Started";
                                            Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
                                            t1.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DownStairs.this,Running.class);
        ...
        Previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DownStairs.this, UpStairs.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_downstairs, menu);
        return true;
    }
    @Override
    ...
    public void store() {
        ...
        String toSpeak = "downstairs dataset recoding completed";
        Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
        t1.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
