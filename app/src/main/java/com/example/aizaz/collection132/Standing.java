 ...
 */
public class Standing extends AppCompatActivity implements SensorEventListener {
    ...
    @SuppressLint("SdCardPath")protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.standng);
      ...
      //  filename= FileName.toString();
        ...
        String nameStr = new String("/storage/sdcard0/" + "Standing" + ".csv");
        ...
        String toSpeak = "Standing Dataset";
        ...
        btnStartTemplate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(v.getId() == R.id.btnStartTemplate){
                    ...
                    list.clear();
                    String ToSpeak = "Standing Dataset Starting in 5 seconds";
                            ...
                            new java.util.TimerTask() {
                                ...
                                public void run() {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            //your code
                                            String toSpeak = "Standing Recording Started";
                                            Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
                                            t1.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Standing.this,UpStairs.class);
        ...
        Previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Standing.this, Sitting.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_standing, menu);
        return true;
    }
    @Override
    ...
    public void store() {
        ...
        for (TimeDataContainer container : list) {
            ...
            txt2.setText("Standing Saved");

            i++;
            //container.getTimeString()

        }
        String toSpeak = "standing dataset recoding completed";
        Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
        t1.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
