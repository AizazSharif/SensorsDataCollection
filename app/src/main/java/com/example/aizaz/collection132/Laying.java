 ...
 */
public class Laying extends AppCompatActivity implements SensorEventListener {
    ...
    @SuppressLint("SdCardPath")protected void onCreate(Bundle savedInstanceState) {
        ...
        String nameStr = new String("/storage/sdcard0/" + "Laying" + ".csv");
        ...
        btnStartTemplate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(v.getId() == R.id.btnStartTemplate){
                    ...
                    list.clear();
                    String ToSpeak = "Laying Dataset Starting in 5 seconds";
                            ...
                            new java.util.TimerTask() {
                                ...
                                public void run() {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            //your code
                                            String toSpeak = "Laying Recording Started";
                                            Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
                                            t1.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Laying.this,Sitting.class);
        ...
        Previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Laying.this,Walking.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_laying, menu);
        return true;
    }
    @Override
    ...
    public void store() {
        ...
        for (TimeDataContainer container : list) {
            ...
            txt2.setText("Laying Saved");

            i++;
            //container.getTimeString()

        }
        String toSpeak = "laying dataset recoding completed";
        Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
        t1.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
