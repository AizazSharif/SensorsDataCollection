 ...
 */
public class Sitting extends AppCompatActivity implements SensorEventListener {
    ...
    @SuppressLint("SdCardPath")protected void onCreate(Bundle savedInstanceState) {
        ...
        String nameStr = new String("/storage/sdcard0/" + "Sitting" + ".csv");
        ...
        String toSpeak = "Sitting Dataset";
        ...
        btnStartTemplate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(v.getId() == R.id.btnStartTemplate){
                    ...
                    String ToSpeak = "Sitting Dataset Starting in 5 seconds";
                            ...
                            new java.util.TimerTask() {
                                ...
                                public void run() {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            //your code
                                            String toSpeak = "Sitting Recording Started";
                                            Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
                                            t1.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sitting.this,Standing.class);
        ...
        Previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sitting.this,Laying.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_sitting, menu);
        return true;
    }
    @Override
    ...
    public void store() {
        ...
        for (TimeDataContainer container : list) {
            ...
            txt2.setText("Sitting Saved");

            i++;
            //container.getTimeString()

        }
        String toSpeak = "Sitting dataset recoding completed";
        Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
        t1.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
